...
public class Main {
	...
	public static void main(String[] args) {
		...
		for (int qtd = 1; qtd <= 3; qtd++) {
			 ...
			 * dataNasc = JOptionPane.showInputDialog("Qual a data de nascimento: "); String
			 * rg = JOptionPane.showInputDialog("Numero do RG: "); String cpf =
			...
			aluno1.setNome(nome);
			/*
			 * aluno1.setIdade(Integer.valueOf(idade)); aluno1.setDataNascimento(dataNasc);
		...
		for (Aluno aluno : maps.get(StatusAluno.APROVADO)) {
			System.out.println("Nome = " + aluno.getNome()+ " Resultado = " + aluno.getAlunoAprovado2() + "com a media de = " + aluno.getMediaNota());
		}
